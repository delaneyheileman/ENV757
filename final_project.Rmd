...
boxplot(KWH ~ REGIONC, data = cleanRECS, col = terrain.colors(length(unique(cleanRECS$REGIONC))), main = "Kilowatt-Hours vs. Census Region", xlab = "Census Region", ylab = "Kilowatt-Hours")
...
#KWH Urban v. Rural 
boxplot(KWH ~ UrbanRural, data = cleanRECS, col = terrain.colors(length(unique(cleanRECS$UrbanRural))), main = "Kilowatt-Hours vs. Urban/Rural Divide", xlab = "Rural v. Urban", ylab = "Kilowatt-Hours")
...
#KWH v. Annual Cost
plot(cleanRECS$KWH, cleanRECS$DOLLAREL, main = "Kilowatt-Hours vs. Electricty Expenditure", xlab = "Kilowatt-Hours (by household)", ylab = "Electricty Expenditure", col = "blue")
