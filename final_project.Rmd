...
cleanRECS$HOUSEHOLDER_RACE <- recs(recs$HOUSEHOLDER_RACE, "7 = '5'")
cleanRECS$HOUSEHOLDER_RACE <- recs(recs$HOUSEHOLDER_RACE, "1 = 'White'; 2 = 'Black/Afr.American'; 3 = 'Native American'; 4 = 'Asian'; 5 = 'Other'")
cleanRECS$MONEYPY <- recs(data$MONEYPY, "1 = '1 - 20k'; 2 = '2 - 40k'; 3 = '3 - 60k'; 4 = '4 - 80k'; 5 = '5 - 100k'; 6 = '6 - 120k'; 7 = '7 - 140k'; 8 = '8 - 140k+'")
...
##Data Cleaning
```{r}
recs$HOUSEHOLDER_RACE <- recs(data$HOUSEHOLDER_RACE, "7 = '5'")
recs$HOUSEHOLDER_RACE <- recs(data$HOUSEHOLDER_RACE, "1 = 'White'; 2 = 'Black/Afr.American'; 3 = 'Native American'; 4 = 'Asian'; 5 = 'Other'")
recs$MONEYPY <- recs(data$MONEYPY, "1 = '1 - 20k'; 2 = '2 - 40k'; 3 = '3 - 60k'; 4 = '4 - 80k'; 5 = '5 - 100k'; 6 = '6 - 120k'; 7 = '7 - 140k'; 8 = '8 - 140k+'")
```
