...
boxplot(KWH ~ ENERGYASST , data = cleanRECS, col = as.factor(cleanRECS$KWH))

table(cleanRECS$ENERGYASST, cleanRECS$REGIONC)
table(cleanRECS$ENERGYASST, cleanRECS$HOUSEHOLDER_RACE)

t.test(KWH ~ ENERGYASST, data = cleanRECS)
